...
class MedMNISTFileManagement(FileManagement):
    def __init__(self, file_name, model_size, channels, classes, data_flag):
        super().__init__(file_name, model_size)
        self.target_dir = self.cloud_model_dir / "MedMNIST"/data_flag
        self.save_dir = self.checkpoints_student_dir / "MedMNIST"/data_flag
        #For MedMNIST
